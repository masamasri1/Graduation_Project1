...
class workeruser extends StatefulWidget {
  final String email;
  const workeruser({Key? key, required this.email}) : super(key: key);

  @override
  State<workeruser> createState() => _workeruserState();
}

// ignore: camel_case_types
class _workeruserState extends State<workeruser> {
  ...
  Future<void> searchbyname(String userName) async {
    var response = await http
        .post(Uri.parse(applink.searchu), body: {'user_name': userName});
                        ...
                        DataTable(
                          ...
                          rows: _userData
                            ...
                            return DataRow(cells: [
                              DataCell(Text(user['users_user_name'])),
