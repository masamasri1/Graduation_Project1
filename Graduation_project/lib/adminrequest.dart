...
class admindashhhh extends StatefulWidget {
  final String email;
  const admindashhhh({Key? key, required this.email}) : super(key: key);

  @override
  State<admindashhhh> createState() => _admindashhhhState();
}

// ignore: camel_case_types
class _admindashhhhState extends State<admindashhhh> {
  ...
  Widget build(BuildContext context) {
    ...
    List pname = _adminData
        ...
        .toList();
    //////////////////////////////////////////////////
    List uname = _userData.map((map) => map['admin_name']).toList();
    List cname = _craftmenData.map((map) => map['admin_name']).toList();
    List rname = _resData.map((map) => map['admin_name']).toList();
    int u = uname.length;
    int c = cname.length;
    int r = rname.length;
    ////////////////////////////////////////////////////
                      ...
                      children: [
                        DataTable(
                          ...
                          columns: [
                            ...
                            const DataColumn(label: Text('Emergency Status')),
                            const DataColumn(label: Text('Delete')),
                            const DataColumn(label: Text('Reservation Info')),

                            // Add other columns as needed
                          ],
                          rows: _resData.map((row) {
                            return DataRow(
                              cells: [
