...
$your_email = $_POST['craftmen_gmail'];

$stmt = $con->prepare("SELECT * FROM craftmen WHERE craftmen_gmail= :craftmen_gmail");
$stmt->bindParam(':craftmen_gmail', $your_email);
$stmt->execute();
...
$stmt = $con->prepare("UPDATE craftmen SET varify = ? WHERE craftmen_gmail = ?");
